...
On the student side, a student logs in by simply submiting an id (such as their andrew id) on the home screen then chooses their current class in the next screen. The student then pays attention to the teacher in class until the teacher administers a quiz. then the student clicks the "refresh" button and the quiz shows up on their screen with a timer signifying how much time they have until their answers are automatically submitted.
